...
const Testimonails = () => {
  return (
    ...
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden ' id='Testimonials'>
      ...
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real Stories From Those WhonFound Home with Us</p>

      <div className=' flex flex-wrap justify-center  gap-4'>
{testimonialsData.map((testimonial, index)=>(
  <div key={index} className='max-w-[330px] border shadow-lg rounded px-4 py-12 text-center'>

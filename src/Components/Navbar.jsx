...
document.body.style.overflow = 'hidden'
  ...
  return (
    <div className='absolute top-10 w-full z-10'>
      <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-6 lg:px-32 bg-transparent'>
...
<a  href="" className='px-4 py-2 rouonClick={()=>setShowMobileMenu(false)}nded-full inline-block'>Project</a>
